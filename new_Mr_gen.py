...
bop = tokenizer.convert_tokens_to_ids('<p>')
eop = tokenizer.convert_tokens_to_ids('</p>')
bon = tokenizer.convert_tokens_to_ids('<n>')
eon = tokenizer.convert_tokens_to_ids('</n>')
